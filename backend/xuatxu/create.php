...
<head>
	...
	<title>Vsshop - Thêm xuất xứ</title>
						...
						<div class="card-body">
							<form  id="frmXuatxu" name="frmcreate" method="post" action="">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="xx_ten" name="xx_ten" placeholder="Tên Xuất xứ" >
								</div>
							...
							<?php
								if(isset($_POST['btnSave'])){
									...
									if(empty($errors)){
										$sql = <<<EOT
													INSERT INTO xuatxu(xx_ten) VALUES('$xx_ten');
										EOT;
	...
	$(document).ready(function() {
		$("#frmXuatxu").validate({
			...
			messages: {
				...
				maxlength: "Tên xuất xứ không được vượt quá 255 ký tự"
				},
			},
			errorElement: "em",
