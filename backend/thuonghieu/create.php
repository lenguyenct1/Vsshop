...
<head>
	...
	<title>Vsshop - Thêm thương hiệu</title>
						...
						<div class="card-body">
							<form  id="frmThuonghieu" name="frmcreate" method="post" action="">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="th_ten" name="th_ten" placeholder="Tên thương hiệu" >
								</div>
							...
							<?php
								if(isset($_POST['btnSave'])){
									...
									if(empty($errors)){
										$sql = <<<EOT
													INSERT INTO thuonghieu(th_ten) VALUES('$th_ten');
										EOT;
	...
	$(document).ready(function() {
		$("#frmThuonghieu").validate({
			...
			messages: {
				...
				maxlength: "Tên thương hiệu không được vượt quá 255 ký tự"
				},
			},
			errorElement: "em",
